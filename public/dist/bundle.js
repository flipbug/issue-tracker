...
/***/ function(module, exports, __webpack_require__) {
	...
	var thunk = __webpack_require__(19);
	...
	var reducer = __webpack_require__(41);
...
/***/ function(module, exports, __webpack_require__) {
	...
	riot.tag2('projects', '<section class="content"> <div class="container"> <projectcreate if="{this.state.showProjectForm}" store="{opts.store}"></projectcreate> </div> </section> <project project="{this.state.currentProject}" store="{opts.store}"></project>', '', '', function(opts) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	function loadProjects() {
	    return function (dispatch, getState) {
	        ...
	        for (var i = 0; i < objects.length; i++) {
	            var project = new _project2.default(objects[i]);
	            var issues = objects[i].issues;
	            for (var j = 0; issues && j < issues.length; j++) {
	                project.issues[j] = new _issue2.default(issues[j]);
	            }
	...
	function addProject(data) {
	    return function (dispatch, getState) {
	        ...
	        project.save(function (result) {
	            dispatch(projectUpdated(new _project2.default(result)));
	...
	function addIssue(project, data) {
	    ...
	    return function (dispatch, getState) {
	        project.addIssue(new _issue2.default(data), function (issue) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Project = function (_Model) {
	    ...
	    function Project(object) {
	        ...
	        _this.api = new _projectApiService2.default();
	        _this.issueApi = new _issueApiService2.default();

	        if (!_this.client_id) {
	            _this.client_id = _get(Project.prototype.__proto__ || Object.getPrototypeOf(Project.prototype), 'generateId', _this).call(_this);
	        }
	        return _this;
	    }
	    ...
	    _createClass(Project, [{
	        key: 'addIssue',
	        value: function addIssue(issue, callback) {
	        ...
	        key: 'removeIssue',
	        value: function removeIssue(id, callback) {
	        ...
	        key: 'toggleIssue',
	        value: function toggleIssue(id, callback) {
	            for (var i = 0; i < this.issues.length; i++) {
	                if (id == this.issues[i].id) {
	        ...
	        key: 'syncIssues',
	        value: function syncIssues(callback) {
	            this.issueApi.get(this.id, function (data) {
	                var issues = [];
	                for (var i = 0; i < data.length; i++) {
	                    issues.push(new _issue2.default(data[i]));
	                }
	                this.issues = issues;
	                console.log(data);
	...
	var ApiService = function () {
	    ...
	    _createClass(ApiService, [{
	        ...
	        value: function get(url, success) {
	            this.request.get(url).type('json').then(function (res) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	riot.tag2('project', '<section class="content"> <div class="container"> <h1 id="project-title">{this.opts.project.name} <small>({this.opts.project.id})</small></h1> <issuecreate project="{this.opts.project}" store="{this.opts.store}"></issuecreate> </div> </section> <section class="content container"> <div class="row"> <div class="col-sm-12"> <issuelist issues="{this.opts.project.issues}" project="{this.opts.project}" store="{this.opts.store}"></issuelist> </div> </div> </section>', '', '', function(opts) {
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	riot.tag2('projectcreate', '<div id="project-form"> <form onsubmit="{submit}"> <div class="input-group search-box"> <input class="form-control form-control-lg" placeholder="New Project..." type="text" name="name"> <span class="input-group-btn"> <input class="btn btn-lg btn-secondary" type="submit" value="Create"> </span> </div> </form> </div>', '', '', function(opts) {
	       ...
	       this.submit = function(e) {
	            e.preventDefault()
	            if (this.name.value) {
	                store.dispatch(actions.addProject({name: this.name.value}));
...
/***/ function(module, exports, __webpack_require__) {
	...
	riot.tag2('projectselector', '<div class="projectselector"> <button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Projects</button> <div class="dropdown-menu"> <span class="dropdown-item" each="{this.state.projects}"> <a href="#" onclick="{switchProject}" data-id="{id}">{name}</a> </span> <div class="dropdown-divider"></div> <button class="dropdown-item" id="project-form-toggle" onclick="{showCreate}">+ New Project</button> </div> </div>', '', '', function(opts) {
	        var actions = __webpack_require__(23);
	        var store = this.opts.store;
...
/***/ function(module, exports, __webpack_require__) {
	...
	riot.tag2('issuelist', '<h3>Latest Issues</h3> <table class="table table-hover issues"> <thead> <tr> <th></th> <th>Issue ID<i class="fa fa-caret-down" aria-hidden="true"></i></th> <th>Prio <i class="fa fa-caret-down" aria-hidden="true"></i></th> <th>Title <i class="fa fa-caret-down" aria-hidden="true"></i></th> <th colspan="2">Date <i class="fa fa-caret-down" aria-hidden="true"></i></th> </tr> </thead> <tbody> <tr data-is="issue" each="{opts.issues}" data="{this}"></tr> </tbody> </table>', '', '', function(opts) {
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	riot.tag2('issue', '<td><input type="checkbox" __checked="{done}" onchange="{toggleIssue}"></td> <td>{id}</td> <td>{priority}</td> <td>{title}</td> <td>{due_date}</td> <td><button onclick="{removeIssue}"><i class="fa fa-trash" aria-hidden="true"></i></button></td>', '', '', function(opts) {

	        var actions = __webpack_require__(23);
	        var project = this.parent.opts.project;
	        var store = this.parent.opts.store;

	        this.toggleIssue = function() {
	            store.dispatch(actions.toggleIssue(project, {id: this.id}));
	        }.bind(this)

	        this.removeIssue = function() {
	            store.dispatch(actions.removeIssue(project, {id: this.id}));
	        }.bind(this)
...
/***/ function(module, exports, __webpack_require__) {
	...
	riot.tag2('issuecreate', '<div class="issue-form"> <form class="card card-block" onsubmit="{submit}"> <div class=" col-md-2"> <select class="form-control form-control" id="priority" name="prio"> <option>Priority</option> <option>1</option> <option>2</option> <option>3</option> </select> </div> <div class=" col-md-2"> <input class="form-control form-control datepicker" id="due_date" placeholder="Date" type="date"> </div> <div class=" col-md-6"> <input type="text" class="form-control form-control" id="title" placeholder="Issue"> </div> <div class="col-md-2"> <button class="btn btn-primary pull-right" onclick="{submit}">Create</button> </div> </form> </div>', '', '', function(opts) {
	        var actions = __webpack_require__(23);
	        var store = this.opts.store;
...
/***/ function(module, exports) {
	...
	function reducer() {
	    var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { projects: [], currentProject: {}, showProjectForm: false, projectLoaded: false };
	    var action = arguments[1];
